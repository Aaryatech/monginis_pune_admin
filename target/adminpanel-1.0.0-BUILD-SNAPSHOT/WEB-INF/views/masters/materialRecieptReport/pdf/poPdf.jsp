...
<table width="100%" border="0"  cellpadding="0" cellspacing="0" style="border-left:1px solid #313131;border-right:1px solid #313131;border-top:1px solid #313131;">
  ...
  <p style="color:#000; font-size:14px; text-align:center;margin:0px;">GSTIIN: <b>27AHIPJ7279D1Z3</b></p>
 </td>
...
duplicate for tranpoter</p> 
  ...
  <tr>
    <td width="50%" colspan="6" style="border-top:1px solid #313131;padding:10px;color:#FFF; font-size:14px;">
        ...
        <p style="color:#000; font-size:13px; text-align:left;margin:0px;">${purchaseOrderHeaderPdf.suppGstin}</p>
    </td>
    ...
    <td width="50%" colspan="5" style="border-top:1px solid #313131;border-left:1px solid #313131; padding:10px;color:#FFF; font-size:15px;">
        <p style="color:#000; font-size:14px; text-align:;left;margin:0px;"> Po No. <b>${purchaseOrderHeaderPdf.poNo}</b>  </p>
        <p style="color:#000; font-size:14px; text-align:left;margin:0px;">Po Date <b><fmt:formatDate pattern = "dd-MM-yyyy" value = "${purchaseOrderHeaderPdf.poDate}" /></b></p>
        <p style="color:#000; font-size:14px; text-align:left;margin:0px;">Delivery AT <br>${purchaseOrderHeaderPdf.delvAtRem}</br></p>
        <p style="color:#000; font-size:14px; text-align:left;margin:0px;">Delivery Date <b><fmt:formatDate pattern = "dd-MM-yyyy" value = "${purchaseOrderHeaderPdf.delvDateRem}" /></b></p>
        <p style="color:#000; font-size:14px; text-align:left;margin:0px;">Transporter<b> ${purchaseOrderHeaderPdf.tranName}</b></p>
    </td>
  </tr>
...
<tr>
    ...
    <td style="border-left:1px solid #313131;  padding:3px 10px;color:#000; font-size:10px;">${purchaseOrderDetail.rmName}</td>
    <td style="border-left:1px solid #313131;  padding:3px 10px;color:#000; font-size:10px;">${purchaseOrderDetail.hsnCode}</td>
    <td align="center" style="border-left:1px solid #313131; padding:3px 10px;color:#000;font-size:10px;">${purchaseOrderDetail.uom}</td>
    <td align="center" style="border-left:1px solid #313131; padding:3px 10px;color:#000; font-size:10px;">${purchaseOrderDetail.poQty}</td>
    <td align="right" style="border-left:1px solid #313131; padding:3px 10px;color:#000; font-size:10px;">${purchaseOrderDetail.poRate}</td> 
    <td align="right" style="border-left:1px solid #313131; padding:3px 10px;color:#000;font-size:10px;">${purchaseOrderDetail.poQty*purchaseOrderDetail.poRate}</td>
  </tr>
  </c:forEach>
