...
<body >
  ...
  <tr>
    ...
    <tr>
      <td colspan="2" align="center" style="padding:5px; border-bottom:1px solid #E7E7E7;"><img src="${pageContext.request.contextPath}/resources/img/monginislogo.jpg" alt="logo" width="100px" height="60px"></td>
    </tr>
    <tr>
  ...
  <tbody>
    <tr>
      ...
      <td width="80%" align="left">${spCakeOrder.frName} </td>
      <td width="0%" ><strong></td>
    </tr>
    <tr>
      <td><strong>Tel:</strong></td>
      <td>${spCakeOrder.frMob}</td>
      <td><strong></td>
      </tr>
      <tr>
