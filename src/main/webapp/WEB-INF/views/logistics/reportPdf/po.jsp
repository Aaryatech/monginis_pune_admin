...
<body>
	...
	<c:forEach items="${viewServicingDetail}" var="viewServicingDetail"
		varStatus="count">
						...
						<table width="100%">
							<tr>
								...
								<td width="53.33%" valign="top"
									...
									<h4 align="center" style="font-size: 16px;">LUTF FOODS
										PVT. LTD.</h4>
									<h6 style="font-weight: bold; margin: 0px; font-size: 10px;"
										align="center">Delivery & Billing Addr.: Delivery &
										Billing Addr.: Sr No 37, Near Angraj Hotel, Kondhwa, Pune,
										Maharashtra 411048</h6>
									<h6 style="font-weight: normal; margin: 0px; font-size: 10px;"
										align="center">CIN NO : CIN NO : U99999MH1986PLC042032</h6>
								</td>
		...
		<table align="center" border="1" cellpadding="0" cellspacing="0"
			...
			<thead>
				<tr style="font-size: 15px;">
					...
					<th align="right" width=10%>Taxable</th>
					<th align="right" width=7%>Tax%</th>
		...
		<h5 style="font-weight: normal; margin: 0px;" align="left">PUNE
			OFFICE : Sr No 37, Near Angraj Hotel, Kondhwa, Pune, Maharashtra
			411048</h5>

		<h5 style="font-weight: normal; margin: 0px;" align="left">PHONE:02067240100,
			FAX : 02067240100, Email : purchase.monginispune@gmail.com</h5>

		<h5 style="font-weight: bold; margin: 0px; padding-bottom: 5px"
			align="left">FACTORY/WORKS: Sr No 37, Near Angraj Hotel,
			Kondhwa, Pune, Maharashtra 411048</h5>
		...
		<table align="center" border="1" cellpadding="0" cellspacing="0"
			...
			<tbody>
				...
				<tr style="font-size: 13px;">
					...
					<td align="right" style="padding: 5px;"><fmt:formatNumber
							type="number" maxFractionDigits="2" minFractionDigits="2"
							value="${row.sprTaxableAmt}" /></td>

					<td align="right" style="padding: 5px;"><fmt:formatNumber
							type="number" maxFractionDigits="2" minFractionDigits="2"
							value="${row.varchar2}" /></td>
					<td align="right" style="padding: 5px;"><fmt:formatNumber
							type="number" maxFractionDigits="2" minFractionDigits="2"
