				...
				<div class="col-md-12">
					...
					<div class="box">
						<div class="box-title">
							...
							<div class="box-tool">
								<%-- <a href="${pageContext.request.contextPath}/insertSarvicing">Servicing Bill</a>  --%>
						...
						<div class="box-content">
							...
							<form id="submitMaterialStore"
								action="${pageContext.request.contextPath}/submitServicing"
								...
								<div class="box-content">
									...
									<input class="form-control" id="typeName" size="16"
										...
										value="${labourGroupId}" size="16" type="hidden"
										name="labourGroupId" />
								...
								<div class="box-content">
									...
									<div class="col-md-3">
										<input type="text" id="billNo" name="billNo"
											placeholder="Bill No" autocomplete="off" class="form-control"
											required>
									</div>
									...
									<div class="col-md-3">
										<input class="form-control date-picker" id="billDate"
											placeholder="Servicing Date" autocomplete="off" size="16"
								...
								<div class="box-content">
									...
									<div class="col-md-3">
										...
										</select> <input class="form-control" id="typeName" size="16"
								...
								<div class="box-content">
									...
									<div class="col-md-3">
										<input class="form-control date-picker" id="servDate"
											placeholder="Servicing Date" size="16" autocomplete="off"
								...
								<div class="box-content">
									...
									<div class="col-md-3">
										<input type="text" id="servAdvRem" autocomplete="off"
											name="servAdvRem" placeholder="Service Advice Remainder"
								...
								<div class="box-content">
									...
									<div class="col-md-3">
										<input type="text" id="totPart" name="totPart"
											placeholder="Total Spare Part" class="form-control" required>
									</div>
								...
								<div class="box-content">
									...
									<div class="col-md-3">
										<input type="text" id="taxaleAmt" name="taxaleAmt"
											placeholder="Taxable Amt" class="form-control" required>
									</div>
								...
								<div id="km" class="box-content">
									...
									<div class="col-md-3">
										<input type="text" id="servDoneKm" name="servDoneKm"
											placeholder="Servicing Done Km"
											onchange="updateNextServicingDueKm()"
											onkeypress="return IsNumeric(event);" ondrop="return false;"
											onpaste="return false;" class="form-control" required>
									</div>


									<div class="col-md-2">Next Due Km*</div>
									<div class="col-md-3">
										<input type="text" id="nextDueKm" name="nextDueKm"
											placeholder="Next Due Km" class="form-control" required>
									</div>
 ...
 -->
							...
							.getJSON(
									...
									function(data) {
										...
										document.getElementById("total").value = (total)
												.toFixed(2);
										document.getElementById("totDisc").value = (disc)
												.toFixed(2);
										document
												.getElementById("totExtraCharge").value = (extraCharge)
												.toFixed(2);
										document.getElementById("taxAmt").value = (taxAmt)
												.toFixed(2);
										document.getElementById("taxaleAmt").value = (taxaleAmt)
												.toFixed(2);
										document.getElementById("totPart").value = (totSparePart)
												.toFixed(2);
										document.getElementById("totalfirst").value = (total)
												.toFixed(2);
										document.getElementById("labCharge").value = (labourCharge)
												.toFixed(2);
										//null detail
										...
										document
												.getElementById("extraChargePer").value = "";
										document.getElementById("taxPer").value = "";
										document.getElementById("discDetail").value = "";
										document
												.getElementById("extraChargeDetail").value = "";
										document
												.getElementById("taxaleAmtDetail").value = "";
										...
										document
												.getElementById("servTypeDetail").value = "";
										$('#servTypeDetail').trigger(
												"chosen:updated");
									});
													...
													for (var i = 0; i < len; i++) {
														if (data.sprId == data1[i].sprId) {
															...
															html += '<option value="' + data1[i].sprId + '" selected>'
																	...
																	+ '</option>';
															document
																	.getElementById("sprId").value = data.sprId;
															$('#sprId')
																	.trigger(
																			"chosen:updated");
														} else {
			...
			$
					.getJSON(
							...
							function(data) {
								...
								document.getElementById("totDisc").value = (disc)
										.toFixed(2);
								document.getElementById("totExtraCharge").value = (extraCharge)
										.toFixed(2);
								document.getElementById("taxAmt").value = (taxAmt)
										.toFixed(2);
								document.getElementById("taxaleAmt").value = (taxaleAmt)
		...
		function updateNextServicingDueKm() {
			...
			$
					.getJSON(
							...
							function(data) {
								if (typeId == 1)
									document.getElementById("nextDueKm").value = data.freqKm
											+ servDoneKm;
								else if (typeId == 6)
									document.getElementById("nextDueKm").value = data.battaryChangeFreq
											+ servDoneKm;
								else if (typeId == 7)
									document.getElementById("nextDueKm").value = data.acChangeFreq
											+ servDoneKm;
								else
									document.getElementById("nextDueKm").value = data.wheelChangeFreq
											+ servDoneKm;
	...
	<script type="text/javascript">
		function validation() {
			...
			} else if (fields[0] == sprId || fields[1] == sprId) {
			...
			} else if (isNaN(taxaleAmtDetail) || taxaleAmtDetail < 0
					|| taxaleAmtDetail == "") {
				isValid = false;
				alert("Please Enter Taxable Amt");
			} else if (isNaN(taxAmtDetail) || taxAmtDetail < 0
					|| taxAmtDetail == "") {
				isValid = false;
			...
			} else if (isNaN(extraChargeDetail) || extraChargeDetail < 0
					|| extraChargeDetail == "") {
				isValid = false;
				alert("Please Enter Extra Charges");
			} else if (isNaN(totalDetail) || totalDetail < 0
					|| totalDetail == "") {
				isValid = false;
				alert("Please Enter Total");
			} else if (isNaN(servTypeDetail) || servTypeDetail < 0
					|| servTypeDetail == "") {
				isValid = false;
														...
														.getJSON(
																...
																function(data) {
																	...
																	if (type == 2) {
																		//alert("in if"); 
																		document
																				.getElementById("km").style.visibility = "hidden";
																		document
																				.getElementById("servDoneKm").required = 0;
																		document
																				.getElementById("nextDueKm").required = 0;
																	} else if (type == 1) {
																		//alert("in else");
																		document
																				.getElementById("km").style.visibility = "visible";
																		document
																				.getElementById("servDoneKm").required = "";
																		document
																				.getElementById("nextDueKm").required = "";
																	}
																});
													...
													$
															.getJSON(
																	...
																	function(
																		...
																		document
																				.getElementById("spareRate").value = data.sprRate1;
																		document
																				.getElementById("discPer").value = data.disc;
																		document
																				.getElementById("extraChargePer").value = data.extraCharges;
																		document
																				.getElementById("taxPer").value = data.cgst
																				+ data.igst
																				+ data.sgst;
																		document
																				.getElementById("taxaleAmtDetail").value = 0;
																		document
																				.getElementById("taxAmtDetail").value = 0;
																		document
																				.getElementById("totalDetail").value = "";
																		document
																				.getElementById("spareQty").value = "";
		...
		function calculateDetail() {
			...
			var taxaleAmtDetail = (spareQty * spareRate) - discDetail
					+ extraChargeDetail;
			var taxAmtDetail = (taxaleAmtDetail * taxPer) / 100;
			var totalDetail = (spareQty * spareRate) - discDetail
					+ extraChargeDetail + taxAmtDetail;
			document.getElementById("taxAmtDetail").value = (taxAmtDetail)
					.toFixed(2);
			document.getElementById("discDetail").value = (discDetail)
					.toFixed(2);
			document.getElementById("extraChargeDetail").value = (extraChargeDetail)
					.toFixed(2);
			document.getElementById("totalDetail").value = (totalDetail)
					.toFixed(2);
			document.getElementById("taxaleAmtDetail").value = (taxaleAmtDetail)
					.toFixed(2);
		}
