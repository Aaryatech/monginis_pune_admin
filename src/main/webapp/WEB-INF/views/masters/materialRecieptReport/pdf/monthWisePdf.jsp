...
<title>Month wise Purchase Report</title>
...
<div align="center"> <h5>Purchase Report (Month wise )&nbsp;&nbsp;&nbsp;&nbsp; From &nbsp; ${from_date}  &nbsp;To &nbsp; ${to_date}</h5></div>
								...
								<c:set var="billAmount"  value="${0 }"/>
								  	<c:forEach items="${staticlist}" var="staticlist" varStatus="count">
												<tr>
													...
													<td  style="text-align:right"><fmt:formatNumber type = "number"  maxFractionDigits = "2" minFractionDigits="2" value = "${staticlist.basicValue}"/></td>
													<c:set var="basicValue"  value="${basicValue+staticlist.basicValue }"/>
													<td  style="text-align:right"><fmt:formatNumber type = "number"  maxFractionDigits = "2" minFractionDigits="2" value = "${staticlist.discAmt}"/> </td>
													<c:set var="discAmt"  value="${discAmt+staticlist.discAmt }"/>
													<td  style="text-align:right"><fmt:formatNumber type = "number"  maxFractionDigits = "2" minFractionDigits="2" value = "${staticlist.other}"/> </td>
													<c:set var="other"  value="${other+staticlist.other }"/>
													<td  style="text-align:right"><fmt:formatNumber type = "number"  maxFractionDigits = "2" minFractionDigits="2" value = "${staticlist.freightAmt}"/></td> 
													<c:set var="freightAmt"  value="${freightAmt+staticlist.freightAmt }"/>
													<td  style="text-align:right"><fmt:formatNumber type = "number"  maxFractionDigits = "2" minFractionDigits="2" value = "${staticlist.insuranceAmt}"/></td> 
													...
													<td  style="text-align:right"><fmt:formatNumber type = "number"  maxFractionDigits = "2" minFractionDigits="2" value = "${staticlist.igst}"/>
													  ...
													  <td  style="text-align:right"><fmt:formatNumber type = "number"  maxFractionDigits = "2" minFractionDigits="2" value = "${staticlist.cess}"/> </td>
