			...
			<div class="row">
				<div class="col-md-12">
					<div class="box">
						<div class="box-title">
							<h3>
								<i class="fa fa-bars"></i> Update Items Line Name
							</h3>
							<div class="box-tool">
						...
						<div class="box-content">
							<form action="${pageContext.request.contextPath}/updateItemsLineMaster" class="form-horizontal"
                          ...
                          <div class="form-group">
                              ...
                              <div class="form-group">
								...
								<div class="form-group">
									<label class="col-sm-3 col-lg-2 control-label" for="hsn_code">Select Line</label>
									<div class="col-sm-9 col-lg-10 controls">
										<select name="line_id" id="line_id" class="form-control" placeholder="Select Line">
											<option value="" selected disabled>Select Line</option>
										 <c:forEach items="${lineMstList}" var="lineList">
										            	  <option value="${lineList.lineId}"><c:out value="${lineList.lineName}"></c:out></option>
										</c:forEach> 
