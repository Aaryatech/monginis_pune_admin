...
<body>
	...
	<div id="main-content">
		...
		<div class="page-title">
			<div>
				<h1>
					<i class="fa fa-file-o"></i>Sales Comaparison Report
				</h1>
				<h4></h4>
			</div>
		</div>
		...
		<div class="box">
			<div class="box-title">
				<h3>
					<i class="fa fa-bars"></i>View Sales Comaparison Report
				</h3>
					...
					<table class="table table-bordered table-striped fill-head "
						...
						<thead>
							<tr>
								...
								<th colspan="2">Prv Month Sale Value</th>
								<th colspan="2" >Last Month</th>
								<th colspan="2">Last Month Diff </th>
								<th rowspan="2">Percentage(%)</th>
								<th rowspan="2">Route</th>
								<th rowspan="2">Route Total</th>
								<th rowspan="2" align="left">Avg Per Day Sale</th>
								<th rowspan="2">11.11%</th>
								<th rowspan="2">14.9%</th>
								<th rowspan="2">17.6%</th>
							</tr>
							<tr>
							<th colspan="2" align="center">March</th>
							<th colspan="2" align="center">April</th>
							<th colspan="2" align="left">Diff March-April</th>
							</tr>
						</thead>
						<tbody>
						</tbody>
											...
											.each(
													...
													function(key, report) {
														...
														var tr = $('<tr></tr>');
													  	...
													  	tr.append($('<td colspan="2"></td>').html(report.prevMonthSale));
													  	tr.append($('<td colspan="2"></td>').html(report.perMonthSale));
													  	tr.append($('<td colspan="2"></td>').html(report.lastMonthDiff));
													  	tr.append($('<td ></td>').html(report.monthDiffInPer));
