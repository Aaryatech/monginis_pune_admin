...
<body>
	...
	<c:url var="getOrderList" value="/showOrderDelveryReportByDate"></c:url>
	...
	<div id="main-content">
		...
		<div class="box">
			<div class="box-title">
				<h3>
					<i class="fa fa-bars"></i>Order Delivery Report
				</h3>
 ...
 -->
		...
		<div class="box">
			<div class="box-title">
				<h3>
					<i class="fa fa-list-alt"></i>Order Delivery Report
				</h3>
		...
		function genPdf() {
			...
			/* 	window
						.open('${pageContext.request.contextPath}/pdfForReport?url=pdf/showSaleReportByDatePdf/'
								+ from_date + '/' + to_date);
			 */
			window.open("${pageContext.request.contextPath}/getOrderDeliveryReportByDate/"
					+ from_date + "/" + to_date);
