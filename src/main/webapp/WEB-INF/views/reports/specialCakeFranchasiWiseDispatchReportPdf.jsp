	...
	<div class="box-content" > 
								...
								<div class="row">
									...
									<div style="">
										...
										<table class="table table-bordered"	style="width: 100%" id="table_grid" border="1">
											...
											<c:set var="sr" value="0"></c:set>
																		<c:forEach items="${dispatchReportList}" var="dispatchReportList" >
																				...
																				<td align="left"><c:out value="${dispatchReportList.catName}" /></td>
																				<td align="left"><c:out value="${dispatchReportList.frName}" /></td>
