...
public class SpecialCake {
    ...
    private float spTax1;
   
    private float spTax2;
   
    private float spTax3;
	...
	public float getSpTax1() {
		return spTax1;
	}



	public void setSpTax1(float spTax1) {
		this.spTax1 = spTax1;
	}



	public float getSpTax2() {
		return spTax2;
	}



	public void setSpTax2(float spTax2) {
		this.spTax2 = spTax2;
	}



	public float getSpTax3() {
		return spTax3;
	}



	public void setSpTax3(float spTax3) {
		this.spTax3 = spTax3;
	}
